      ...
      <div className="w-full max-w-md space-y-8">
        ...
        {destroyed && (
          <div className="bg-red-950/50 border border-red-900 p-4 text-center">
            ...
            <p className="text-zinc-500 text-xs mt-1">All messages are deleted.</p>
          </div>
        )}
        ...
        {error === "room-full" && (
          <div className="bg-red-950/50 border border-red-900 p-4 text-center">
            ...
            <p className="text-zinc-500 text-xs mt-1">Max limit has been reached.</p>
          </div>
        )}

        <div className="text-center space-y-2">
          <h1 className="text-2xl font-bold tracking-tight text-green-500">{">"}private_chat</h1>
          <p className="text-zinc-500 text-sm">A self destructing chat room</p>
        </div>
